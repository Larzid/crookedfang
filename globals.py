...
def init_player(action):
  ...
  if action == 'new':
    fighter_component = combat.Fighter(faction='player', hp=100, defense=1, power=4, sight=7, poison_resist=30, xp_bonus=350, lvl_base=200, lvl_factor=150, death_function=combat.player_death)
